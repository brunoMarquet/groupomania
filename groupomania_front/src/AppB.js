...
import Header from "./componentsB/HeaderB";
import Footer from "./componentsB/FooterB";
import Login from "./componentsB/LoginB";
import MainB from "./componentsB/MainB";
  ...
  return (
    <div>
      ...
      <UserContext.Provider value={theContext}>
        <Header></Header>
        <Login theContext={theContext} setContext={setContext} />
        <TheMain />
        <Footer></Footer>
